            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">Nosso Endereço</h3>
                    <p className="text-gray-700">  Belo Horizonte - MG </p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-4">
    <a href="wa.me/5531997835768" className="flex items-start space-x-4 group">
        <div className="flex-shrink-0 mt-1">
        ...
        <div>
            <h3 className="font-bold text-gray-900 mb-1 group-hover:text-green-800 transition-colors">Whatsapp</h3>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        className="w-full px-6 py-3 bg-green-800 hover:bg-green-700 text-white font-medium rounded-md transition-colors duration-300"
                      >
                        Enviar Mensagem
                      </button>
                    </div>
