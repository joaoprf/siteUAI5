        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              Fundada em 2025, a Uai5 nasceu com o propósito de democratizar o acesso à IA conversacional e tornar 
              chatbots uma ferramenta prática e acessível para empresas de todos os tamanhos.
            </p>
